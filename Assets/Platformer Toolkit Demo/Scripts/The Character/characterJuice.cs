...
namespace GMTK.PlatformerToolkit
{
    ...
    public class characterJuice : MonoBehaviour
    {
        ...
        [Foldout("Components - Particles",true)]
        [SerializeField] 
        ...
        [Foldout("Components - Audio", true)]
        [SerializeField] 
        private AudioSource jumpSFX;

        [SerializeField] 
        private AudioSource landSFX;

        [Foldout("Settings - Squash and Stretch",true)]
        ...
        [Foldout("Debug - Calculations",true)]
        ...
        [Foldout("Debug - Current State",true)]
        [ReadOnly][SerializeField] 
        bool squeezing;
        ...
        [Foldout("Platformer Toolkit Stuff",true)]
        [SerializeField] private jumpTester jumpLine;
